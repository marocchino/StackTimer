...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    var applicationFilesDirectory: NSURL {
        // Returns the directory the application uses to store the Core Data store file. This code uses a directory named "tw.shim.StackTimerSwift" in the user's Application Support directory.
        let fileManager = NSFileManager.defaultManager()
        let urls = fileManager.URLsForDirectory(.ApplicationSupportDirectory, inDomains: .UserDomainMask)
        let appSupportURL: AnyObject = urls[urls.endIndex - 1]
        return appSupportURL.URLByAppendingPathComponent("tw.shim.StackTimerSwift")
    }
    ...
    var managedObjectModel: NSManagedObjectModel {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("StackTimerSwift", withExtension: "momd")
    ...
    var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
        ...
        let url = applicationFilesDirectory.URLByAppendingPathComponent("StackTimerSwift.storedata")
